...
class Konbini
{
    ...
    enum class LoggedUserMenuOPTS : std::uint8_t
    {
        ...
        AddItemToCart = 6,
        ChangeQuantity = 7,
        RemoveProductFromCart = 8,
        FinalizePurchase = 9,
        ChangelanguageToJapanese = 10,
        DeleteAccount = 11,
        Logout = 12,
        Exit = 13,
    };
    ...
    enum class LoggedAdminMenuOPTS : std::uint8_t
    {
        ...
        RemoveProductFromCart = 8,
        FinalizePurchase = 9,
        AddNewProductToStore = 10,
        ChangeStoreProductQuantity = 11,
        RemoveProductFromTheStore = 12,
        ChangelanguageToJapanese = 13,
        DeleteAccount = 14,
        Logout = 15,
        Exit = 16,
    };
