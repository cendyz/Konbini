...
class LanguageManagerTest : public ::testing::Test
{
  protected:
    ...
    inline static const std::array<std::string, numOfLines> dictKeys{
        ...
        "BYE",          "PRD_QNT",        "PRD_N_QNT",     "SUCC_CHNQ",  "WRN_QNT",        "PRD_ADD_CART",
        "MENU_BACK",    "NAME",           "NAME_ERR",      "LOGIN",      "WRN_LOGIN",      "PSWD",
        "PSWD_ERR",     "EMAIL",          "EMAIL_ERR",     "EMAIL_EXST", "EMAIL_CHANGED",  "ACC_CREATED",
        "SUCC_LOG",     "WRN_NAME_EMAIL", "YOUR_PASS",     "NEW_PASS",   "NEW_PASS_CHNGD", "EMP_CART",
        "WRN_PRD",      "PRD_NAME",       "NOT_IN_C",      "ITM_REMV",   "CRT_SUM",        "DSC_CRT_SUM",
        "LNG_CHN",      "THNK_SHP",       "LOG_OUT",       "ACC_DEL",    "U_MENU_1",       "U_MENU_2",
        "U_MENU_3",     "U_MENU_4",       "U_MENU_5",      "U_MENU_6",   "U_MENU_7",       "U_MENU_8",
        "U_MENU_9",     "U_MENU_10",      "U_MENU_11",     "U_MENU_12",  "U_MENU_13",      "U_MENU_14",
        "S_ACC_0",      "S_ACC_1",        "S_ACC_2",       "S_ACC_3",    "N_EMAIL",        "A_MENU_1",
        "A_MENU_2",     "A_MENU_3",       "A_MENU_4",      "A_MENU_5",   "A_MENU_6",       "A_MENU_7",
